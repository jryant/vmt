...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://www.dm-mailinglist.com/subscribe_forms/embed.css?f=d6d4b631&sbg=1" media="all">
...
?>
		...
		<div id="top-header" class="<?php echo esc_attr( $secondary_nav_class ); ?>">
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<?php if ( '' !== ( $et_phone_number = et_get_option( 'phone_number' ) ) ) : ?>
					<span id="et-info-phone"><a href="tel:+1-604-779-8143"><?php echo esc_html( $et_phone_number ); ?></a></span>
				<?php endif; ?>
	...
	<?php endif; // true ==== $et_top_info_defined ?>
		...
		<a id="contact-link" href="#contact"><span id="et-info-phone"> Contact Jason</a>
